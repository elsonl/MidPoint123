...
class NearbySearch : ObservableObject{
    ...
    func getData(callback: @escaping () -> Void){
        ...
        guard let url = URL(string: "https://maps.googleapis.com/maps/api/place/nearbysearch/json?key=AIzaSyCO0auMyg79gTc2R0p1B4p4STTQsGcvJY4&location=\(midLat),\(midLong)&radius=16093.4&type=restaurant") else {
