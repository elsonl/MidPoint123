...
class NearbySearch : ObservableObject{
    ...
    init(geocoding : Geocoding, placeDetail : PlaceDetail){
    ...
    func getData(callback: @escaping (_ responses3: Response3) -> Void){
        ...
        guard let url = URL(string: "https://maps.googleapis.com/maps/api/place/nearbysearch/json?key=AIzaSyCO0auMyg79gTc2R0p1B4p4STTQsGcvJY4&location=\(midLat),\(midLong)&radius=5000") else {
