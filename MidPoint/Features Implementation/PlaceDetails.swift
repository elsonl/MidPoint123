...
class PlaceDetails : ObservableObject{
     var  responses4 = Response4()
    
    func getData(callback: @escaping () -> Void){

        print("getting data")
        guard let url = URL(string: "https://maps.googleapis.com/maps/api/place/details/json?fields=name%2Crating%2Cformatted_phone_number%2Cformatted_address%2Cwebsite%2Copening_hours%2Cprice_level%2Cuser_ratings_total%2Cphoto%2Creview&place_id=ChIJXwbcTpvAxokRpQBerYSgPqs&key=AIzaSyCO0auMyg79gTc2R0p1B4p4STTQsGcvJY4") else {
